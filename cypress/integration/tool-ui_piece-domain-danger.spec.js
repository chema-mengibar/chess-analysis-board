...
const testPrefix = 'ui-button_piece-domain-danger'
const buttonSelector = '#button-paint-domain-danger-square'
let targetRect;
describe('Button', () => {

    before(() => {
        cy.visit('/v2/?fen=8/1P6/8/3B4/8/5r2/8/8 w KQkq - 0 1')
    })
    ...
    it(`should test action functionality`, () => {
        ...
        cy.get('#markers-f7').children().first().should('to.have.attr', 'href', '#marker-circle-white');
        cy.get('#markers-b3').children().first().should('to.have.attr', 'href', '#marker-circle-white');
