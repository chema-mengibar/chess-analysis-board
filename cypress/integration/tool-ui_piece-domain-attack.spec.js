...
const testPrefix = 'ui-button_piece-domain-attack'
const buttonSelector = '#button-paint-domain-attack-square'
let targetRect;
describe('Button', () => {
    ...
    it(`should test action functionality`, () => {
        ...
        cy.get('#markers-b7').children().first().should('to.have.attr', 'href', '#marker-circle-black');
